...
public class BuyMinecoinScreen extends Screen {
    ...
    public BuyMinecoinScreen(Text title) {
        super(title);
    }
    ...
    protected void init() {
        super.init();
        if (browser == null) {
            String url = "https://www.microsoft.com/p/1-000-minecoins/9n8g2c9l074r";
    ...
    private int mouseY(double y) {
        return (int) ((y - BROWSER_DRAW_OFFSET) * minecraftClient.getWindow().getScaleFactor());
    }

    private int scaleX(double x) {
        return (int) ((x - BROWSER_DRAW_OFFSET * 2) * minecraftClient.getWindow().getScaleFactor());
    }

    private int scaleY(double y) {
        return (int) ((y - BROWSER_DRAW_OFFSET * 2) * minecraftClient.getWindow().getScaleFactor());
    }
